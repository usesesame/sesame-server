...
func (s *Store) AcceptReleaseCandidate(ctx context.Context, actor Account, candidate ReleaseCandidate, ipHash string) (Release, error) {
	...
	release := Release{ID: releaseID, Channel: candidate.Channel, Platform: candidate.Platform, Architecture: candidate.Architecture, Version: candidate.Version, ArtifactObjectKey: candidate.Artifact.ObjectKey, SHA256: candidate.Artifact.SHA256, Signature: candidate.Artifact.UpdaterSignature, SigningKeyID: candidate.Artifact.UpdaterSigningKeyID, SupportedWindows: candidate.SupportedWindows, ReleaseNotesURL: candidate.ReleaseNotesURL, Status: "draft", RolloutPercent: 100, UpdateEnabled: true}
