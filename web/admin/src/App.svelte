<script lang="ts">
  ...
  function publishBlockers(release: Release): string[] {
    ...
    if ((release.supportedWindows ?? '').length === 0) missing.push('the supported Windows versions')
