...
const noHtmlSinks = {
  'no-restricted-syntax': [
    'error',
    { selector: "MemberExpression[property.name='innerHTML']", message: 'Build nodes instead. Admin data is untrusted.' },
    { selector: "MemberExpression[property.name='outerHTML']", message: 'Build nodes instead. Admin data is untrusted.' },
    { selector: "MemberExpression[property.name='insertAdjacentHTML']", message: 'Build nodes instead. Admin data is untrusted.' },
